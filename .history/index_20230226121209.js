...
$(document).ready(function () {
  function myFunction(x) {
    if (x.matches) { // If media query matches
      ...
      document.querySelector(".features-item-2").innerText = "test";
      document.querySelector(".features-item-3").innerText = "test";
      document.querySelector(".features-item-4").innerText = "yellow";
    } else {

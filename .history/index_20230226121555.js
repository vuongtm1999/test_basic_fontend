...
$(document).ready(function () {
  function myFunction(x) {
    if (x.matches) { // If media query matches
      ...
      document.querySelector(".features-item-2 .features-item-descript__below").innerText = "Not only chat now you can voice chat and make calls <br> to quickly connect with the performer";

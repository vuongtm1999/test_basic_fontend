...
$(document).ready(function () {
  function myFunction(x) {
    if (x.matches) { // If media query matches
      console.log(document.querySelector(".features-item-2"));
      document.querySelector(".features-item-2 .features-item-descript__below").innerText = "test";
      document.querySelector(".features-item-3 .features-item-descript__below").innerText = "test";
      document.querySelector(".features-item-4 .features-item-descript__below").innerText = "yellow";
    } else {
